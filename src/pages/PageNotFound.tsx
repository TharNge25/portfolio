    ...
    <div className="min-h-screen bg-black text-white font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8">
        ...
        <div className="mt-12 p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg text-left max-w-sm mx-auto font-mono text-xs md:text-sm text-zinc-500 overflow-hidden">
           <p><span className="text-purple-400">const</span> <span className="text-yellow-400">location</span> = <span className="text-green-400">useLocation()</span>;</p>
           <p><span className="text-purple-400">if</span> (location.path !== <span className="text-orange-400">found</span>) {'{'}</p>
           <p className="pl-4"><span className="text-blue-400">throw new</span> <span className="text-red-400">Error</span>("404");</p>
           <p>{'}'}</p>
        </div>
