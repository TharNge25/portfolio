...
import { 
  Github, ExternalLink, Folder, Code2, 
  Smartphone, Layout, ArrowUpRight 
} from 'lucide-react';
          ...
          >
            ...
            <div className="relative h-56 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                 <a href={project.links.github} className="p-3 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-[#4ADE80] hover:text-black transition-colors" title="View Code">
                   <Github size={20} />
                 </a>
                 <a href={project.links.demo} className="p-3 bg-white/10 backdrop-blur-md rounded-full text-white hover:bg-[#4ADE80] hover:text-black transition-colors" title="Live Demo">
            ...
            <div className="p-6 flex flex-col flex-grow">
              <div className="flex justify-between items-start mb-4">
                ...
                <ArrowUpRight className="text-zinc-600 group-hover:text-[#4ADE80] group-hover:translate-x-1 group-hover:-translate-y-1 transition-all" size={24} />
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-auto">
                {project.tech.map((t, idx) => (
                  <span key={idx} className="px-3 py-1 text-xs font-medium text-zinc-300 bg-zinc-900 rounded-md border border-zinc-800">
                    {t}
                  </span>
                ))}
              </div>
